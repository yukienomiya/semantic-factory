...
class SenseAnnotation {
    ...
    static fieldsCheck(m) {
        ...
        for (let index121 = 0; index121 < cbSenses.length; index121++) {
            let cbSense = cbSenses[index121];
            {
                if (!cbSense.checked) {
                    continue;
                }
                for (let index122 = 0; index122 < cbSenses.length; index122++) {
                    let cbS = cbSenses[index122];
                    {
                        cbS.required = false;
                    }
                }
