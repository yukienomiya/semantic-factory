...
class MyAnnotation {
    ...
    static main(args) {
        ...
        $.getJSON(MyAnnotation.REST_URL, "task=MY_ANNOTATION", (result, a, ctx) => {
            ...
            let page = MyAnnotation.page(hypernym, words);
            $("body").append(page);
            return null;
        });
    }
