    ...
    static main(args) {
        $.get(SenseAnnotation.LOGIN_CHECK, (result, a, ctx) => {
            ...
            if (((o1, o2) => { if (o1 && o1.equals) {
                ...
                window.location.replace(SenseAnnotation.LOGIN_URL);
            }
            return null;
        });
 ...
 */
SenseAnnotation.HOME_URL = "home.html";
/**
 * Represents the url of the LogoutServlet.
 */
SenseAnnotation.LOGOUT_URL = "logout.jsp";
/**
 * Represents the path of the logo.
 */
SenseAnnotation.LOGO = "images/FS.svg";
/**
 ...
 */
SenseAnnotation.NEXT_TASK = "nextTask.jsp";
/**
