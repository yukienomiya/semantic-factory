    ...
    static main(args) {
        $.get(TranslationValidation.LOGIN_CHECK, (result, a, ctx) => {
            ...
            if (((o1, o2) => { if (o1 && o1.equals) {
                ...
                window.location.replace(TranslationValidation.LOGIN_URL);
            }
            return null;
        });
 ...
 */
TranslationValidation.LOGO = "images/FS.svg";
/**
 ...
 */
TranslationValidation.NEXT_TASK = "nextTask.jsp";
/**
